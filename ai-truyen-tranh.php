...
<div class="page-head wrap">
  ...
  <p>Cùng bạn Bo trên đường đến trường. Con hãy chọn hành động cho Bo — mỗi lựa chọn sẽ dẫn tới một câu chuyện khác nhau!</p>
</div>

<div class="wrap"><div class="path-row" id="pathRow"></div></div>
...
<section class="library">
  <div class="wrap">
    <div class="section-head">
      ...
      <p>Mỗi truyện có nhân vật, bối cảnh Việt Nam riêng và nhiều kết thúc khác nhau tuỳ theo lựa chọn của con.</p>
    </div>
    <div class="lib-grid">
      <div class="lib-card">
        <div class="lib-visual">🏫</div>
        <div class="lib-info"><h5>Bo đến trường</h5><span>Chương 1 · Đang chơi</span></div>
      </div>
      <div class="lib-card">
        <div class="lib-visual">🚲</div>
        <div class="lib-info"><h5>Chuyến xe đạp của Na</h5><span>3 chương</span><div class="lib-lock">🔒 Mở khoá ở cấp độ 5</div></div>
      </div>
      <div class="lib-card">
        <div class="lib-visual">👮</div>
        <div class="lib-info"><h5>Một ngày cùng chú Công an</h5><span>4 chương</span><div class="lib-lock">🔒 Mở khoá ở cấp độ 8</div></div>
      </div>
    </div>
  </div>
</section>
...
<script src="assets/js/ai-truyen-tranh.js?v=5"></script>
</body>
</html>
