...
?>
<main class="wrap community-page"><div class="page-head"><span class="eyebrow-pill"><span class="dot"></span> Cộng đồng học an toàn</span><h1>Chia sẻ một tình huống trên đường</h1><p>Chỉ gửi ảnh đường phố, biển báo hoặc góc qua đường. AI sẽ lọc bước đầu và quản trị viên duyệt trước khi chia sẻ cho học sinh.</p><a class="btn btn-ghost" href="community-feed.php">👀 Xem tình huống đã duyệt</a> <a class="btn btn-ghost" href="community-admin.php">🛡️ Kiểm duyệt</a></div>
