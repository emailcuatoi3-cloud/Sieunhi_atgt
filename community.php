...
$PAGE = [
    'title' => 'Đóng góp tình huống · Siêu Nhí AI',
    'nav'   => '',
    'crumb' => ['href' => 'index.php', 'label' => '← Trang chủ', 'title' => '🤝 Cộng đồng học an toàn'],
];
require __DIR__ . '/partials/site-head.php';
require __DIR__ . '/partials/site-nav.php';
?>
<main class="wrap community-page"><div class="page-head"><span class="eyebrow-pill"><span class="dot"></span> Cộng đồng học an toàn</span><h1>Chia sẻ một tình huống trên đường</h1><p>Chỉ gửi ảnh đường phố, biển báo hoặc góc qua đường. AI sẽ lọc bước đầu và quản trị viên duyệt trước khi chia sẻ cho học sinh.</p><a class="btn btn-ghost" href="community-feed.php">👀 Xem tình huống đã duyệt</a><?php if ($user['role'] === 'admin'): ?> <a class="btn btn-ghost" href="community-admin.php">🛡️ Kiểm duyệt</a><?php endif; ?></div>
