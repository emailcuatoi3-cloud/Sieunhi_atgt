...
<div class="auth-shell">
  ...
  <div class="auth-card">
    ...
    <p style="font-size:11.5px; color:rgba(255,255,255,0.42); text-align:center; margin:-14px 0 20px;">Hệ thống sẽ tự nhận diện đúng vai trò tài khoản của bạn sau khi đăng nhập.</p>
    ...
    <form class="auth-form" id="loginForm" method="post" novalidate>
      <div class="auth-field">
        ...
        <div class="auth-input-wrap">
          <span class="fi">📧</span>
          <input type="text" id="loginEmail" name="email" value="<?= e($prefillEmail) ?>" placeholder="ten@vidu.com" autocomplete="username" required>
        </div>
      </div>
    ...
    <p class="auth-foot" style="margin-top:10px; font-size:11.5px; color:rgba(255,255,255,0.4);">Tài khoản demo (sau khi chạy seed.php): hocsinh@demo.com · phuhuynh@demo.com · giaovien@demo.com · admin@demo.com — mật khẩu <code>123456</code></p>
  </div>
</div>
