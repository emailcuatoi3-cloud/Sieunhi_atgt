...
<div class="auth-shell">
  ...
  <div class="auth-card">
    ...
    <div class="role-tabs cols-3" id="roleTabs">
      <button type="button" class="role-tab<?= $selectedRole === 'hocsinh' ? ' active' : '' ?>" data-role="hocsinh"><span class="rt-ic">🧒</span>Học sinh</button>
      <button type="button" class="role-tab<?= $selectedRole === 'phuhuynh' ? ' active' : '' ?>" data-role="phuhuynh"><span class="rt-ic">👨‍👩‍👧</span>Phụ huynh</button>
      <button type="button" class="role-tab<?= $selectedRole === 'giaovien' ? ' active' : '' ?>" data-role="giaovien"><span class="rt-ic">👩‍🏫</span>Giáo viên</button>
    </div>
    ...
    <form class="auth-form" id="registerForm" method="post" novalidate>
      ...
      <div class="auth-field">
        ...
        <div class="auth-input-wrap">
          <span class="fi">🙋</span>
          <input type="text" id="regName" name="name" value="<?= e($name) ?>" placeholder="Nguyễn Văn A" autocomplete="name" required>
        </div>
      </div>
      ...
      <div class="auth-field">
        ...
        <div class="auth-input-wrap">
          <span class="fi">📧</span>
          <input type="email" id="regEmail" name="email" value="<?= e($email) ?>" placeholder="ten@vidu.com" autocomplete="email" required>
        </div>
      </div>
      ...
      <div class="auth-field">
        ...
        <div class="auth-input-wrap">
          <span class="fi">🔒</span>
          <input type="password" id="regPassword" name="password" placeholder="Tối thiểu 6 ký tự" autocomplete="new-password" required minlength="6">
      ...
      <div class="auth-field">
        ...
        <div class="auth-input-wrap">
          <span class="fi">🔒</span>
          <input type="password" id="regPasswordConfirm" name="password_confirm" placeholder="Nhập lại mật khẩu" autocomplete="new-password" required minlength="6">
          <button type="button" class="auth-toggle-pw">👁️</button>
        </div>
      </div>

      <label class="auth-check"><input type="checkbox" name="agree"> Tôi đồng ý với <a class="auth-link" href="#">Điều khoản sử dụng</a> &amp; <a class="auth-link" href="#">Chính sách bảo mật</a></label>

      <button type="submit" class="btn cta-primary auth-submit" id="registerSubmitBtn">✨ Tạo tài khoản</button>
    </form>
