...
$PAGE = [
    'title' => 'Người qua đường thông minh · Siêu Nhí An Toàn Giao Thông AI',
    'nav'   => 'thu-thach',
...
?>
    ...
    <div class="page-head wrap">
        <span class="eyebrow-pill"><span class="dot"></span> 🚶 Game 1 · Người qua đường thông minh</span>
    ...
    <?php
    $PAGE['scripts'] = ['assets/js/sound-fx.js', 'assets/js/game-engine.js', 'assets/js/game-pedestrian.js'];
