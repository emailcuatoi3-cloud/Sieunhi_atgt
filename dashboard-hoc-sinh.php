...
<div class="app">
  ...
  <main class="main">
    ...
    <div class="stat-row">
      <div class="mini-stat-card"><div class="st-ic">⭐</div><b><?= (int)$progress['xp'] ?></b><span>Điểm XP</span></div>
      <div class="mini-stat-card"><div class="st-ic">🪙</div><b><?= number_format((int)$progress['coin'], 0, ',', '.') ?></b><span>Coin</span></div>
      <div class="mini-stat-card"><div class="st-ic">🔥</div><b><?= (int)$progress['streak_days'] ?> ngày</b><span>Streak học tập</span></div>
      <div class="mini-stat-card"><div class="st-ic">🏅</div><b><?= (int)$badgeCount ?></b><span>Huy hiệu đạt được</span></div>
    </div>
      ...
      <div>
        <div class="card level-card">
          ...
          <div>
            ...
            <span style="font-size:12px; color:rgba(255,255,255,0.5);"><?= (int)$progress['xp'] ?> / <?= $xpNeeded ?> XP đến cấp <?= $level + 1 ?></span>
            <div class="mini-bar full" style="margin-top:8px; width:160px;"><i style="width:<?= $xpIntoLevel ?>%;"></i></div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="notif-item"><div class="notif-ic">🎮</div><div><div class="notif-text">Bạn Na vừa vượt qua thử thách "Siêu nhí xử lý tình huống".</div><div class="notif-time">Hôm qua</div></div></div>
        </div>
      </div>
    </div>
  </main>
