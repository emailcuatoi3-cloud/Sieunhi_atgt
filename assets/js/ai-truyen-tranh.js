...
document.addEventListener("DOMContentLoaded", () => {
  const story = {
    start: {
      chapter: "Chương 1",
      tag: "📍 Cổng trường Tiểu học Việt Nam",
      emoji: "🏫",
      speaker: "Bo",
      avatar: "🧒",
      ...
      choices: [
        ...
        {
          label: "Tìm vạch qua đường và quan sát đèn tín hiệu",
          icon: "🦓",
          next: "safeCross",
        },
      ],
    ...
    rush: {
      ...
      choices: [
        ...
        {
          label: "Bình tĩnh lùi lại vỉa hè và tìm vạch qua đường",
          icon: "🚶",
          next: "recover",
        },
      ],
    ...
    safeCross: {
      ...
      choices: [
        {
          label: "Nghe theo Na, chạy nhanh qua trước khi đèn đổi",
          icon: "🏃",
          next: "peerPressure",
        },
        {
          label: "Đợi đèn xanh rồi mới qua cùng Na",
          icon: "🟢",
          next: "goodWait",
        },
      ],
    ...
    peerPressure: {
      ...
      choices: [
        {
          label: "Rút kinh nghiệm, hứa sẽ luôn chờ đèn xanh",
          icon: "🙋",
          next: "endMid",
        },
        {
          label: "Nghĩ rằng lần này chỉ là may mắn thôi",
          icon: "🤷",
          next: "endBad",
        },
      ],
    ...
    goodWait: {
      ...
      choices: [
        {
          label: "Vẫy tay cảm ơn chú công an đang điều tiết giao thông",
          icon: "👋",
          next: "endGood",
        },
      ],
    ...
    recover: {
      ...
      choices: [
        {
          label: "Ghi nhớ bài học và kể lại cho AI Gia sư",
          icon: "💬",
          next: "endMid",
        },
      ],
  ...
  function renderNode(key) {
    ...
    void stage.offsetWidth; // reflow để restart animation mỗi lần chuyển cảnh
    stage.innerHTML = ComicScenes.render(key);
    stage.classList.add("scene-in");
    ...
    if (node.ending) {
      const badgeClass =
        node.ending === "good" ? "good" : node.ending === "mid" ? "mid" : "bad";
      const badgeLabel =
        node.ending === "good"
          ? "🏆 Kết thúc tốt nhất"
          : node.ending === "mid"
            ? "👍 Kết thúc ổn"
            : "⚠️ Kết thúc cần cải thiện";
      endBlock.style.display = "block";
      endBlock.innerHTML =
        `<div class="ending-badge ${badgeClass}">${badgeLabel}</div>` +
        baseEndHtml;
    } else {
